    ...
    <div class="container header-inner">
        ...
        <nav>
            ...
            <?php if (ehFuncionario()): ?>
                <?php include __DIR__ . '/controles_funcionario.php'; ?>
            <?php endif; ?>

            <?php if (estaLogado()): ?>
                <a href="logout.php">Sair (<?= htmlspecialchars($_SESSION['usuario_nome']) ?>)</a>
            <?php else: ?>
                <a href="acesso.php" class="<?= $paginaAtual === 'acesso.php' ? 'ativo' : '' ?>">Entrar</a>
            <?php endif; ?>
        </nav>
    </div>
</header>
